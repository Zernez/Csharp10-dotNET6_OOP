...
Person jill = new() { Name = "Jill" }; // call instance method
Person baby1 = mary.ProcreateWith(harry); 
baby1.Name = "Gary"; // call static method
...
foreach (Person p in people) { WriteLine($" {p.Name}"); }
...
if (aliceInPerson is Employee){
    ...
    Employee explicitAlice = (Employee)aliceInPerson; // safely do something with explicitAlice
}

//Alternative
//if (aliceInPerson is Employee explicitAlice)
//{
//    WriteLine($"{nameof(aliceInPerson)} IS an Employee"); // safely do something with explicitAlice
//}
...
catch (PersonException ex) { WriteLine(ex.Message); }
...
// #pragma warning disable SA1200 // UsingDirectivesMustBePlacedWithinNamespace using System;
